...
class DelamodePdfAssistant extends PdfClient
{
    ...
    public function processLines(array $lines, ?string $attachment_filename = null)
    {
        ...
        [$freight_price, $freight_currency] = explode(' ', $freight);
        ...
        [$cargos, $loading_locations, $destination_locations] = $this->extractLoads($cargo_block);
    ...
    public function extractCargo(array $lines)
    {
        ...
        $cargo['title'] = implode('; ', array_filter($title_parts));
